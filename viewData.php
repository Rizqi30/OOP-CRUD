                ...
                <tbody>
                    ...
                    foreach ($data as $ddata => $list) { ?>
                        <tr>
                            ...
                            <td><a href="editData.php?id=<?php echo base64_encode(sha1(rand()) . "|" . $list->id) ?>" class="btn btn-success edit">Edit</a> | <a href="deleteData.php?id=<?php echo base64_encode(sha1(rand()) . "|" . $list->id) ?>" class="btn btn-outline-danger">Delete</a></td>
                        </tr>
                    <?php
                        $i++;
                    } ?>
